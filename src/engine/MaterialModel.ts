...
export const MATERIALS: Record<string, MaterialModel> = {
  ...
  copper_nab_c955: createMaterial({
    name: 'NiAl Bronze C95500',
    youngsModulus: 118000,
    poissonRatio: 0.32,
    yieldStress: 275,
    uts: 620,
    density: 7530,
  ...
  copper_nickel_c715: createMaterial({
    name: 'Copper-Nickel C71500 (70-30)',
    youngsModulus: 150000,
    poissonRatio: 0.34,
    yieldStress: 170,
    uts: 390,
  ...
  aluminum_5456: createMaterial({
    name: 'Aluminum 5456-H116 (Marine)',
    youngsModulus: 71000,
    poissonRatio: 0.33,
    yieldStress: 230,
    uts: 315,
  ...
  steel_4150: createMaterial({
    name: 'AISI 4150 (Cr-Mo High-Strength)',
    youngsModulus: 205000,
    poissonRatio: 0.29,
    yieldStress: 1105,
    uts: 1240,
  ...
  cobalt_stellite12: createMaterial({
    name: 'Stellite 12 (Co-Cr-W)',
    youngsModulus: 218000,
    poissonRatio: 0.30,
    yieldStress: 620,
    uts: 850,
  ...
  magnesium_ze41a: createMaterial({
    name: 'Magnesium ZE41A-T5 (Zr-RE)',
    youngsModulus: 45000,
    poissonRatio: 0.35,
    yieldStress: 140,
    uts: 205,
  ...
  titanium_6242: createMaterial({
    name: 'Ti-6242 (6Al-2Sn-4Zr-2Mo)',
    youngsModulus: 114000,
    poissonRatio: 0.32,
    yieldStress: 900,
    uts: 1000,
  ...
  aluminum_7055: createMaterial({
    name: 'Aluminum 7055-T77 (Ultra-High)',
    youngsModulus: 72000,
    poissonRatio: 0.33,
    yieldStress: 620,
    uts: 655,
  ...
  steel_1060: createMaterial({
    name: 'AISI 1060 (High-Carbon Spring)',
    youngsModulus: 205000,
    poissonRatio: 0.29,
    yieldStress: 480,
    uts: 810,
  ...
  steel_1018: createMaterial({
    name: 'AISI 1018 (Low-Carbon Mild)',
    youngsModulus: 205000,
    poissonRatio: 0.29,
    yieldStress: 220,
    uts: 400,
