...
### 누적 통계 (EXP-180 기준, 26/03/11 18:55)
...
| Phase 5 | ✅ 완료 (S5.1~S5.5+추가개선 144건, EXP-028~180) |
| 충족 FR | FR-01~FR-15 (15/15) |
| 충족 NF | NF-01~NF-08 (8/8) |
| 현재 UI Score | 10/10 |
| 빌드 크기 | 849 kB (gzip 232 kB) |
| 재료 라이브러리 | 24종 (Al 6061/3003/5052/7075/2024, Mild Steel/4340/1095/SS304, Cu C110/Cu-Be, Ti Gr2/Ti-6Al-4V, Brass C260, Ni 200/Monel 400/Inconel 718/Hastelloy X, Zn ZAMAK3, Mg AZ31B, PC/PEEK/PA6, Tungsten) |
| 차트 | 3종 (Load-Displacement, Energy-Displacement, Stress-Strain) |
| 카테고리 | 9종 (Al, Fe, Cu, Ti, Ni, Poly, Zn, Mg, W) |
| 내충격성 지표 | SEA (J/kg), CFE (%), F_peak, F_mean, UTS 활용률 바, flow stress |
| 신규 기능 (v1.4) | StressStrainChart, 카테고리 뱃지, HUD flow stress/st/s, About 토글(A), JSON 내보내기(J), 뷰포트 진행바, CFE 차트 표시 |
...
| 현재 Step | v1.4 — EXP-180 |
| 마지막 push | 26/03/11 18:55 |
| 마지막 활동 | 26/03/11 18:55 |
