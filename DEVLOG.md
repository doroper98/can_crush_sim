...
### 누적 통계 (EXP-150 기준, 26/03/11 16:15)
...
| Phase 5 | ✅ 완료 (S5.1~S5.5+추가개선 114건, EXP-028~150) |
| 충족 FR | FR-01~FR-15 (15/15) |
| 충족 NF | NF-01~NF-08 (8/8) |
| 현재 UI Score | 10/10 |
| 빌드 크기 | 841 kB (gzip 230 kB) |
| 재료 라이브러리 | 15종 (Al 6061/3003/5052/7075, Mild Steel, AISI 4340, SS304, Cu C110, Cu-Be C17200, Ti-6Al-4V, Brass C260, Nickel 200, Zinc ZAMAK3, Mg AZ31B, Inconel 718) |
| 내충격성 지표 | SEA (J/kg), CFE (%), F_peak, F_mean, UTS 활용률 바 |
| 신규 기능 (v1.3) | 정렬 가능 재료 테이블, 비강도(σy/ρ) 열, 셀 색상 코딩, HUD 토글, 재료 순환 단축키, 벽시계 경과시간 |
...
| 현재 Step | v1.3 — EXP-150 |
| 마지막 push | 26/03/11 16:15 |
| 마지막 활동 | 26/03/11 16:15 |
