...
### 누적 통계 (EXP-190 기준, 26/03/11 19:40)
...
| Phase 5 | ✅ 완료 (S5.1~S5.5+추가개선 154건, EXP-028~190) |
| 충족 FR | FR-01~FR-15 (15/15) |
| 충족 NF | NF-01~NF-08 (8/8) |
| 현재 UI Score | 10/10 |
| 빌드 크기 | 851 kB (gzip 232 kB) |
| 재료 라이브러리 | 30종 (Al×5, Fe×4, Cu×2, Ti×2, Ni×4, Poly×3, Zn, Mg, Sn, W, Pb, Zr, Ag, Au, Co) |
| 차트 | 3종 (Load-Displacement, Energy-Displacement, Stress-Strain) |
| 카테고리 | 15종 (Al, Fe, Cu, Ti, Ni, Poly, Zn, Mg, Sn, W, Pb, Zr, Ag, Au, Co) |
| 내충격성 지표 | SEA (J/kg), CFE (%), F_peak, F_mean, UTS 활용률 바, flow stress |
| 신규 기능 (v1.4+) | StressStrainChart 그리드+n값, 카테고리 뱃지, HUD flow stress/st/s, MaterialTable 검색 필터, 뷰포트 진행바, CFE 차트 표시, 30재료 |
...
| 현재 Step | v1.4+ — EXP-190 |
| 마지막 push | 26/03/11 19:40 |
| 마지막 활동 | 26/03/11 19:40 |
