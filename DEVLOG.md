...
| S1.2 | 실린더 캔 메시 생성 | FR-05 | NF-01 | ⬜ 미착수 | - |
| S1.3 | 카메라 컨트롤 (CATIA 호환) | FR-02, FR-15 | NF-05 | ⬜ 미착수 | - |
| S1.4 | 좌표축 표시 | FR-14 | - | ⬜ 미착수 | - |
| S1.5 | Viewport Toolbar | FR-03, FR-04 | - | ⬜ 미착수 | - |
| S1.6 | 그리드 표시 | - | - | ⬜ 미착수 | - |
| S1.7 | Mass-Spring 물리 엔진 기초 | FR-10 | NF-01, NF-02 | ⬜ 미착수 | - |
| S1.8 | 강체 실린더 + 접촉 처리 | FR-07, FR-10 | - | ⬜ 미착수 | - |
| S1.9 | 탄소성 재료 모델 | FR-06, FR-10 | - | ⬜ 미착수 | - |
| S1.10 | 시뮬레이션 Play/Pause/Reset | FR-13 | - | ⬜ 미착수 | - |
