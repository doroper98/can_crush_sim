...
| S1.11 | Control Panel 기본 구조 | FR-05, FR-06, FR-09 | NF-06 | ⬜ 미착수 | - |
| S2.1 | OCCT.js WASM 통합 | FR-01 | NF-04 | ⬜ 미착수 | - |
| S2.2 | STP 파일 드래그&드롭 임포트 | FR-01 | - | ⬜ 미착수 | - |
| S2.3 | STL 직접 로드 | FR-01 | - | ⬜ 미착수 | - |
| S2.4 | 강체 형상 변경 | FR-07 | - | ⬜ 미착수 | - |
...
| S3.8 | GIF/MP4 내보내기 | FR-13 | - | ⬜ 미착수 | - |
| S4.1 | 뉴로모피즘 스타일 전면 적용 | - | NF-05 | ⬜ 미착수 | - |
| S4.2 | 슬라이더 Inset 스타일 | - | NF-06 | ⬜ 미착수 | - |
| S4.3 | 버튼 Pressed 피드백 | - | NF-05 | ⬜ 미착수 | - |
| S4.4 | 영역 구분 3D Depth 적용 | - | - | ⬜ 미착수 | - |
